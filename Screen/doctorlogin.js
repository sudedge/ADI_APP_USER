...
<Text style={{marginTop:30,marginBottom:100}}>
    <Text style={{fontFamily:"Roboto-Bold",color:"black",fontSize:15}}>Don’t Have Account? </Text> <TouchableOpacity  onPress={()=>navigation.navigate("doctorsignup")} activeOpacity={0.5}><Text style={{color:"#009AE5",fontFamily:"Roboto-Medium",fontSize:15}}>Sign up </Text></TouchableOpacity>
</Text>
</ScrollView>
</LinearGradient>
