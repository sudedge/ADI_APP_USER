...
<View style={{width:windowWidth,position:"absolute",bottom:150,alignItems:"center"}}>
 ...
 <View>
    <Image style={{position:"absolute",right:10}} source={require("../assets/Image/patient.png")}/>
        <Ripple onPress={()=>navigation.navigate('patientlogin')} rippleOpacity={1} rippleDuration={600} rippleColor={Color.white} style={[Globalstyle.btncontainer]}>
    ...
    <View style={{marginTop:30}}>
         ...
         <Ripple onPress={()=>navigation.navigate('labtechlogin')} rippleOpacity={1} rippleDuration={600} rippleColor={Color.white} style={[Globalstyle.btncontainer]}>
    ...
    <View style={{marginTop:30}}>
         ...
         <Ripple onPress={()=>navigation.navigate('doctorlogin')} rippleOpacity={1} rippleDuration={600} rippleColor={Color.white} style={[Globalstyle.btncontainer]}>
