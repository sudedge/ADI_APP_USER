...
export default function Verificartion() {
  return (
    <View style={{width:windowWidth,height:windowHeight}} >
      ...
      <Text style={{fontFamily:'Roboto-Medium',fontSize:24}}>Upload Your Prescription</Text>
      <Text style={{fontSize:13,color:"#808080",fontFamily:"Roboto-Medium",marginTop:5}}>File should be in Pdf,Jpeg or Png form</Text>
      <View style={{height:180,borderWidth:1,width:"90%",borderStyle:"dashed",borderWidth:3,borderRadius:8,marginTop:30,borderColor:"#808080",alignItems:"center",justifyContent:"center"}}>
       ...
       <Text style={{color:Color.white,fontFamily:"Roboto-Medium",fontSize:18}}>Browse</Text>
       </Ripple> 
      </View>
    </View>
  )
