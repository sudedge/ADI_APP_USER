...
export default function User() {
  ...
  const dispatch = useDispatch();
    ...
    const [selectcategoryIndex2,setselectcategoryIndex2]=React.useState();
  ...
  return (
      <SafeAreaView style={{flex:1}}>
       ...
       <View style={{alignItems:"center"}}>
           ...
           <Text style={Globalstyle.headofsubhead}>As Lab Technician</Text>
...
<Text style={{marginTop:10,marginBottom:70}}>
    <Text style={{fontFamily:"Roboto-Bold",color:"black",fontSize:15}}>Already Have Account?</Text> <TouchableOpacity onPress={()=>navigation.navigate("labtechlogin")} activeOpacity={0.5}><Text style={{color:"#009AE5",fontFamily:"Roboto-Medium",fontSize:15}}>Login </Text></TouchableOpacity>
</Text>
</ScrollView>
</LinearGradient>
